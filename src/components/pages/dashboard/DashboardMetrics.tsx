  ...
  return (
    <div className="bg-gray-800/50 border border-gray-700/50 rounded-2xl p-4 sm:p-6 backdrop-blur-sm">
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        <div
          className={`w-10 h-10 sm:w-12 sm:h-12 bg-gradient-to-r ${color} rounded-xl flex items-center justify-center border-green-400`}
        >
          {typeof icon === "string" ? (
            <img
              src="/onlyLogo.png"
...
const DashboardMetrics: React.FC<DashboardMetricsProps> = ({ onError }) => {
  ...
  const earningsChange = calculateChange(
    dashboardData.totalReferralTokensEarned,
    "earnings"
  );
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
      <MetricCard
        ...
        icon={Users}
        color="from-[#00feae] to-green-600"
        isLoading={isLoading}
      />
