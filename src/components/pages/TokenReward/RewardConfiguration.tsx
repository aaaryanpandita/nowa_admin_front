...
<div className="bg-gray-800/50 border border-gray-700/50 rounded-2xl p-6 backdrop-blur-sm">
  <div className="flex items-center justify-between mb-6 flex-wrap">
    <div className="flex items-center space-x-3 mb-4 sm:mb-0">
      <div className="w-12 h-12 sm:w-10 sm:h-10 bg-gradient-to-r from-[#00FFA9] to-[#00CC87] rounded-xl flex items-center justify-center">
        <Settings2 className="w-6 h-6 sm:w-5 sm:h-5 text-black" />
      </div>
      <h2 className="text-2xl sm:text-xl font-semibold text-white">Reward Configuration</h2>
    </div>
    ...
    <div className="flex items-center space-x-3">
      ...
      >
        <span className="sm:inline">Reward: {currentReferralReward} NOWA</span>
      </button>
