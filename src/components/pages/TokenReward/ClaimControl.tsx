...
const ClaimControl: React.FC = () => {
  ...
  <div className="flex items-center space-x-3 mb-6">
    <div className="w-12 h-12 sm:w-10 sm:h-10 bg-gradient-to-r from-blue-500 to-blue-600 rounded-xl flex items-center justify-center">
      <Calendar className="w-6 h-6 sm:w-5 sm:h-5 text-white" />
    </div>
    <h2 className="text-2xl sm:text-xl font-semibold text-white">Claim Control</h2>
  </div>
